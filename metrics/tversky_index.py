...
class TverskyIndex(CumulativeIterationMetric):
    """
    Compute Root Tversky Index between two tensors. It can support both multi-classes and multi-labels tasks.
    ...
    def _compute_tensor(self, y_pred: torch.Tensor, y: torch.Tensor):  # type: ignore
        ...
        return self.compute_tversky_index(
